...
function SecurityStartPage() {
    ...
    const playBeep = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SecurityStartPage.useCallback[playBeep]": (frequency = 800, duration = 100)=>{
            try {
                ...
                setTimeout({
                    "SecurityStartPage.useCallback[playBeep]": ()=>audioCtx.close()
                }["SecurityStartPage.useCallback[playBeep]"], duration + 100);
            } catch (e) {
                console.log('Audio error:', e);
            }
        }
    }["SecurityStartPage.useCallback[playBeep]"], []);
    ...
    const playStartupSound = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SecurityStartPage.useCallback[playStartupSound]": ()=>{
            playBeep(400, 100);
            setTimeout({
                "SecurityStartPage.useCallback[playStartupSound]": ()=>playBeep(600, 100)
            }["SecurityStartPage.useCallback[playStartupSound]"], 100);
            setTimeout({
                "SecurityStartPage.useCallback[playStartupSound]": ()=>playBeep(800, 150)
            }["SecurityStartPage.useCallback[playStartupSound]"], 200);
        }
    }["SecurityStartPage.useCallback[playStartupSound]"], [
        playBeep
    ]);
    ...
    const playIconSound = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SecurityStartPage.useCallback[playIconSound]": ()=>{
    ...
    const startSequence = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SecurityStartPage.useCallback[startSequence]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SecurityStartPage.useEffect": ()=>{
            const handleKeyDown = {
                "SecurityStartPage.useEffect.handleKeyDown": (e)=>{
            ...
            }["SecurityStartPage.useEffect.handleKeyDown"];
            window.addEventListener('keydown', handleKeyDown);
            return ({
                "SecurityStartPage.useEffect": ()=>window.removeEventListener('keydown', handleKeyDown)
            })["SecurityStartPage.useEffect"];
        }
    }["SecurityStartPage.useEffect"], [
        startSequence
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                if (SpeechRecognition) {
                    ...
                    recognitionRef.current.onresult = ({
                        "SecurityStartPage.useEffect": (event)=>{
                            const transcript = Array.from(event.results).map({
                                "SecurityStartPage.useEffect.transcript": (result)=>result[0].transcript
                            }["SecurityStartPage.useEffect.transcript"]).join('').toLowerCase();
                    ...
                    recognitionRef.current.onerror = ({
                        "SecurityStartPage.useEffect": ()=>setIsListening(false)
                    })["SecurityStartPage.useEffect"];
        ...
        "SecurityStartPage.useEffect": ()=>{
            ...
            if (currentIconIndex < SECURITY_ICONS.length) {
                const timer = setTimeout({
                    "SecurityStartPage.useEffect.timer": ()=>{
                        playIconSound();
                        setCurrentIconIndex({
                            "SecurityStartPage.useEffect.timer": (prev)=>prev + 1
                        }["SecurityStartPage.useEffect.timer"]);
                    }
                }["SecurityStartPage.useEffect.timer"], CONFIG.ICON_INTERVAL);
                return ({
                    "SecurityStartPage.useEffect": ()=>clearTimeout(timer)
                })["SecurityStartPage.useEffect"];
            } else {
                setPhase('complete');
            }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
          ...
          `,
            ...
            phase === 'complete' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                style: {
                    textAlign: 'center',
                    zIndex: 10,
...
_s(SecurityStartPage, "NchTU2Hix/yuy2bBnNsPpdJrJHg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c1 = SecurityStartPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "Octagon");
__turbopack_context__.k.register(_c1, "SecurityStartPage");
...
//# sourceMappingURL=_dad51ebd._.js.map